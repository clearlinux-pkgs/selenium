...
Version  : 3.3.1
Release  : 32
URL      : http://pypi.debian.net/selenium/selenium-3.3.1.tar.gz
Source0  : http://pypi.debian.net/selenium/selenium-3.3.1.tar.gz
...
%prep
%setup -q -n selenium-3.3.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489852813
