...
Version  : 3.4.1
Release  : 35
URL      : https://pypi.debian.net/selenium/selenium-3.4.1.tar.gz
Source0  : https://pypi.debian.net/selenium/selenium-3.4.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1493645906
